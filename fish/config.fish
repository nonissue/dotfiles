...
switch (uname)
    case Darwin
        ...
        # set -U fish_user_paths "/opt/local/bin /opt/local/sbin /usr/local/opt/fzf/bin /usr/local/bin /usr/bin /usr/local/sbin /bin /usr/sbin /sbin /usr/local/opt/curl/bin /opt/local/bin /usr/local/bin $HOME/.cargo/bin"
        # fish_add_path "/opt/local/bin /opt/local/sbin /usr/local/opt/fzf/bin /usr/local/bin /usr/bin /usr/local/sbin /bin /usr/sbin /sbin /usr/local/opt/curl/bin /usr/local/bin /Users/apw/.cargo/bin /opt/local/bin /usr/local/bin /usr/bin /bin /usr/sbin /sbin /Library/Apple/usr/bin /usr/local/aria2/bin /opt/homebrew/bin/"
        # M1/Monterey Fix
