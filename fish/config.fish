...
switch (uname)
    case Darwin
        ...
        set -x fish_user_paths "/opt/local/bin:/opt/local/sbin:/usr/local/opt/fzf/bin:/usr/local/bin:/usr/bin:/usr/local/sbin:/bin:/usr/sbin:/sbin:/usr/local/opt/curl/bin" $fish_user_paths
        set -g os "macOS"
    case Linux
        set -g os "Linux"
